...
const Header = (props) => {
  return (
    <div className={`header-header ${props.rootClassName} `}>
      ...
      >
        <Link to="/properties-home-en" className="header-logo">
          {props.logo}
        </Link>
        <div data-thq="thq-navbar-nav" className="header-desktop-menu">
          <nav className="header-links">
            <Link to="/properties-home-en" className="header-nav12">
              {props.nav1}
            </Link>
            <Link to="/commercial-properties-en" className="header-nav22">
              {props.nav2}
            </Link>
            <Link to="/residential-properties-en" className="header-nav32">
              {props.nav3}
            </Link>
            <a href="#PROPERTIES-ATHENS-FOOTER-ENG" className="header-nav42">
              {props.nav4}
            </a>
          </nav>
        </div>
        ...
        >
          <div className="header-nav">
            ...
            <nav className="header-links1 Heading">
              <span className="header-nav121">{props.nav121}</span>
              <span className="header-nav221">{props.nav221}</span>
              <span className="header-nav321">{props.nav321}</span>
              <span className="header-nav421">{props.nav312}</span>
            </nav>
...
Header.defaultProps = {
  ...
  nav2: 'Comercial Properties',
  nav3: 'Residential Properties',
